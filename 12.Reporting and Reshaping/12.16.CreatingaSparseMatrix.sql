SELECT
    CASE WHEN deptno = 10 THEN ename ELSE NULL END AS d10,
    CASE WHEN deptno = 20 THEN ename ELSE NULL END AS d20,
    CASE WHEN deptno = 30 THEN ename ELSE NULL END AS d30,
    ...
    CASE WHEN job = 'ANALYST' THEN ename ELSE NULL END AS anals,
